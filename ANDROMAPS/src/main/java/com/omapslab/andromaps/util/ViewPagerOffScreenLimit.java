...
public class ViewPagerOffScreenLimit extends ViewGroup {
    ...
    public ViewPagerOffScreenLimit(Context context) {
        super(context);
        initViewPager();
    }

    public ViewPagerOffScreenLimit(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
