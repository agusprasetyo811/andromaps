...
/**
 * Created by omapslab on 6/14/17.
 */

public class ListHeaderDecoration extends RecyclerView.ItemDecoration {

    private View mLayout;

    public ListHeaderDecoration(final Context context, RecyclerView parent, @LayoutRes int resId) {
