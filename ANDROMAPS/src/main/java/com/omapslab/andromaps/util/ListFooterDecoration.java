...
public class ListFooterDecoration extends RecyclerView.ItemDecoration {

    private View mLayout;

    public ListFooterDecoration(final Context context, RecyclerView parent, @LayoutRes int resId) {
